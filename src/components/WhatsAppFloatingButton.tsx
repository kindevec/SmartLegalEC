  ...
  return (
    <aside aria-label="Contacto flotante" className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        <div className="relative w-14 h-14 sm:w-15 sm:h-15 rounded-full bg-gradient-to-tr from-[#20ba59] via-[#25D366] to-[#2be873] text-white flex items-center justify-center shadow-[0_10px_25px_rgba(37,211,102,0.45)] border-2 border-white/30 transition-all duration-300 group-hover:scale-110 group-active:scale-95">
          <WhatsAppIcon className="w-8 h-8 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]" />
        </div>

        {/* Floating Tooltip Pill (Reveals on Hover) */}
        <div className="hidden sm:flex absolute right-full mr-3.5 px-3.5 py-1.5 rounded-xl bg-slate-950/90 backdrop-blur-md text-white border border-slate-700/80 text-xs font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300 shadow-xl pointer-events-none items-center gap-1.5 font-heading">
