...
export const FOUNDER_PROFILE = {
  ...
  bio: [
    'Soy Luis Fernando Guerra Padilla, abogado ecuatoriano con <strong class="font-bold text-slate-900">más de 15 años de experiencia profesional</strong>, especializado en <strong class="font-bold text-slate-900">protección de datos personales</strong>, <strong class="font-bold text-slate-900">tecnología</strong>, <strong class="font-bold text-slate-900">telecomunicaciones</strong> y <strong class="font-bold text-slate-900">asesoría jurídica empresarial</strong>.',
    'Mi carrera se ha desarrollado principalmente en sectores en los que el derecho debe convivir permanentemente con la <strong class="font-bold text-slate-900">tecnología</strong>, la <strong class="font-bold text-slate-900">regulación</strong> y las <strong class="font-bold text-slate-900">necesidades del negocio</strong>.',
    'Durante cerca de diez años formé parte del <strong class="font-bold text-slate-900">equipo jurídico - regulatorio del principal operador de telecomunicaciones del Ecuador</strong>. Esta experiencia me permitió trabajar desde dentro de una organización de gran escala, asesorando a distintas áreas de negocio en <strong class="font-bold text-slate-900">regulación de telecomunicaciones</strong>, <strong class="font-bold text-slate-900">protección de datos</strong>, <strong class="font-bold text-slate-900">derecho digital</strong>, <strong class="font-bold text-slate-900">contratos y nuevos productos</strong>, así como en <strong class="font-bold text-slate-900">procedimientos administrativos</strong> ante autoridades regulatorias.',
    'Posteriormente, me incorporé a una <strong class="font-bold text-slate-900">firma jurídica con amplia trayectoria en el sector tecnológico</strong>, donde asesoré a empresas nacionales e internacionales y consolidé mi especialización en <strong class="font-bold text-slate-900">privacidad, protección de datos y tecnología</strong>, sobre la base de la experiencia corporativa y regulatoria adquirida durante cerca de <strong class="font-bold text-slate-900">nueve años como abogado in-house</strong>.',
    'Actualmente asesoro a organizaciones de distintos sectores y actúo como <strong class="font-bold text-slate-900">Delegado de Protección de Datos externo</strong>, acompañando a empresas no solo en el <strong class="font-bold text-slate-900">cumplimiento de la Ley Orgánica de Protección de Datos Personales</strong>, sino también en la <strong class="font-bold text-slate-900">toma de decisiones</strong> relacionadas con <strong class="font-bold text-slate-900">riesgos, proveedores, contratos, nuevas tecnologías, incidentes</strong> y proyectos que involucran tratamiento de información personal.',
  ],
  workingPhilosophy: {
