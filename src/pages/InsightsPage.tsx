          ...
          <div className="absolute inset-0 z-0 pointer-events-none">
            <picture className="w-full h-full">
              ...
              <img
                ...
                width="1920"
                height="1080"
                className="w-full h-full object-cover object-center lg:object-right opacity-40"
                loading="eager"
                fetchPriority="high"
                decoding="async"
              />
            ...
            {/* Smooth Cinematic Deep Navy Gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#071326] via-[#071326]/90 via-50% to-[#071326]/60" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#071326] via-transparent to-[#071326]/50" />
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              ...
              <div className="max-w-3xl">
                ...
                {/* Lead Summary */}
                <p className="text-xs sm:text-sm lg:text-base text-slate-300 font-normal leading-relaxed text-justify mb-6">
            ...
            <article className="lg:col-span-8 bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-lg border border-slate-200 space-y-8">
              ...
              <div className="space-y-6 pt-2 text-slate-800 leading-relaxed text-sm sm:text-base border-t border-slate-100">
                {activeArticle.content.map((paragraph, idx) => {
                  ...
                  return (
                    <p key={idx} className="whitespace-pre-line text-sm sm:text-base text-slate-700 leading-relaxed text-justify">
                      {paragraph}
                    </p>
                  );
                })}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-8 items-start">
                ...
                <div className="lg:col-span-8 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal mb-4 text-justify">
                      {article.summary}
                    </p>
